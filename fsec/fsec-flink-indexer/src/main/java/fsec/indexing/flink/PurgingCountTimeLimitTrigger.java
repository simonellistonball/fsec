...
public class PurgingCountTimeLimitTrigger<W extends Window> extends Trigger<Object, W> {
    ...
    private PurgingCountTimeLimitTrigger(long maxCount) {
        this.stateDesc = new ReducingStateDescriptor("count", new PurgingCountTimeLimitTrigger.Sum(), LongSerializer.INSTANCE);
    ...
    public static <W extends Window> PurgingCountTimeLimitTrigger<W> of(long maxCount) {
        return new PurgingCountTimeLimitTrigger(maxCount);
    }
